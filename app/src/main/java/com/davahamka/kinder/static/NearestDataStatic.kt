...
object NearestDataStatic {
    val dataCard = listOf<Nearest>(
        Nearest("Good Quality Banana", "Bu Siti", 100, "Good", "https://aceh.kemenag.go.id/file/fotoberita/250837.jpg", 4.0, 5.0, position = LatLng(-7.5682219,110.8293164)),
        Nearest("Rice With Satay", "Hadi", 100, "Good", "https://awsimages.detik.net.id/community/media/visual/2021/03/06/sate-pak-heri-asli-2.jpeg?w=700&q=90", 4.0, 5.0, position = LatLng(-7.5682219,110.8293164)),
        Nearest("Medium Quality Beef", "Raymon", 100, "Good", "https://www.jessicagavin.com/wp-content/uploads/2020/06/cuts-of-beef-12.jpg", 4.0, 5.0, position = LatLng(-7.5682219,110.8293164)),
        Nearest("Egg", "Dafa", 100, "Good", "https://cdn.britannica.com/94/151894-050-F72A5317/Brown-eggs.jpg", 4.0, 5.0, position = LatLng(-7.5680953,110.8290245)),
